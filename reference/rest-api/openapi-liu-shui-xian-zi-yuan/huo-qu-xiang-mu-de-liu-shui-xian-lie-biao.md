...
| 参数名称 | 参数类型 | 必须 | 参数说明 |
| :--- | :--- | :--- | :--- |
| data | [分页数据包装模型流水线模型-列表信息](huo-qu-xiang-mu-de-liu-shui-xian-lie-biao.md) | 否 | 数据 |
...
| 参数名称 | 参数类型 | 必须 | 参数说明 |
| :--- | :--- | :--- | :--- |
| records | List&lt;[流水线模型-列表信息](huo-qu-xiang-mu-de-liu-shui-xian-lie-biao.md)&gt; | 是 | 数据 |
...
| groupLabel | List&lt;[PipelineGroupLabels](huo-qu-xiang-mu-de-liu-shui-xian-lie-biao.md)&gt; | 否 | 流水线分组和标签 |
