...
#### PUT  [yourIpAddress]/ms/openapi/api/apigw/v3/projects/{projectId}/pipelines/{pipelineId}/pipeline\_update
...
| 参数名称 | 参数类型 | 必须 | 参数说明 | 默认值 |
| :--- | :--- | :--- | :--- | :--- |
| body | [PipelineModelAndSetting]() | 是 | 流水线模型与设置 |  |
...
| HTTP代码 | 说明 | 参数类型 |
| :--- | :--- | :--- |
| 200 | successful operation | [数据返回包装模型配置流水线结果]() |
...
| 参数名称 | 参数类型 | 必须 | 参数说明 |
| :--- | :--- | :--- | :--- |
| model | [流水线模型-创建信息]() | 是 | 流水线模型 |
| setting | [PipelineSetting]() | 否 | 流水线设置 |
