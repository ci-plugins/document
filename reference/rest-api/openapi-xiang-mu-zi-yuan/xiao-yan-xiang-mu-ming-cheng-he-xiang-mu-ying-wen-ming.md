...
#### GET  /apigw-app/v3/projects/{validateType}/names/validate
...
```javascript
curl -X GET '[请替换为API地址栏请求地址]?name={name}&amp;english_name={english_name}&amp;app_secret={app_secret}&amp;app_code={app_code}'
```
