...
#### POST  /apigw-app/v3/projects/{projectId}/templates/{templateId}/templateInstances
...
```javascript
curl -X POST '[请替换为API地址栏请求地址]?version={version}&amp;useTemplateSettings={useTemplateSettings}&amp;app_secret={app_secret}&amp;app_code={app_code}'
```
