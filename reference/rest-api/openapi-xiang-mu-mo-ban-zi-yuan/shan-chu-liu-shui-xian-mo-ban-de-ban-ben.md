...
#### DELETE  /apigw-app/v3/projects/{projectId}/templates/{templateId}/versions/{version}
...
| HTTP代码 | 说明 | 参数类型 |
| :--- | :--- | :--- |
| 200 | successful operation | [数据返回包装模型Boolean](shan-chu-liu-shui-xian-mo-ban-de-ban-ben.md) |
