...
| :------------- | :----------------------------------------------------------- | :--- | :-------------------- |
| data           | List< [pipeline model-list information](batch-get-pipeline-layout-and-configuration.md) > | no   | data                  |
...
| groupLabel           | List<[PipelineGroupLabels](batch-get-pipeline-layout-and-configuration.md)> | no   | Pipelined grouping and labeling        |
...
| model                | [Pipeline model - Create information](batch-get-pipeline-layout-and-configuration.md) | no   | Arrangement details                    |
