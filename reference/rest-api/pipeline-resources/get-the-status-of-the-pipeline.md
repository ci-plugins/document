...
| :-------- | :------------------- | :----------------------------------------------------------- |
| 200       | successful operation | [Data returns packaging model pipeline model-list information](get-the-status-of-the-pipeline.md) |
...
## Data returns packaging model pipeline model-list information

| Parameter name | Parameter type                                               | must | Parameter description |
| :------------- | :----------------------------------------------------------- | :--- | :-------------------- |
| data           | [Pipeline model - List information](get-the-status-of-the-pipeline.md) | no   | data                  |
...
| groupLabel           | List<[PipelineGroupLabels](get-the-status-of-the-pipeline.md)> | no   | Pipelined grouping and labeling        |
...
| model                | [Pipeline model - Create information](get-the-status-of-the-pipeline.md) | no   | Arrangement details                    |
...
| name                 | string                                                       | is   | name                                          |
| stages               | List< [pipeline model-phase](get-the-status-of-the-pipeline.md) > | is   | Stage set                                     |
...
| checkIn            | [StagePauseCheck](get-the-status-of-the-pipeline.md)         | no   | Whether retries can be made at the current Stage             |
...
| containers         | List< [pipeline model-polymorphic base class >](get-the-status-of-the-pipeline.md) | is   | Container set                                                |
| id                 | string                                                       | no   | Phase ID                                                     |
| stageControlOption | [StageControlOption](get-the-status-of-the-pipeline.md)      | is   | Flow control options                                         |
| checkOut           | [StagePauseCheck](get-the-status-of-the-pipeline.md)         | no   | Whether retries can be made at the current Stage             |
...
| reviewParams   | List< [Manual audit - Custom parameters](get-the-status-of-the-pipeline.md) > | no   | reviewParams          |
| manualTrigger  | boolean                                                      | no   | manualTrigger         |
| checkTimes     | integer                                                      | no   | checkTimes            |
| reviewDesc     | string                                                       | no   | reviewDesc            |
| reviewGroups   | List<[Stage Audit group information](get-the-status-of-the-pipeline.md) > | no   | reviewGroups          |
...
| options        | List< [Manual Review - Custom parameters - drop-down list Sword](get-the-status-of-the-pipeline.md) > | no   | Drop-down list        |
...
| params         | List< [Manual audit - Custom parameters](get-the-status-of-the-pipeline.md) > | no   | Audit incoming variables             |
...
| elements            | List[ ](get-the-status-of-the-pipeline.md)> | no   | elements              |
| name                | string                                      | no   | name                  |
| id                  | string                                      | no   | id                    |
...
| elementPostInfo       | [Element post message](get-the-status-of-the-pipeline.md)    | no   | elementPostInfo       |
