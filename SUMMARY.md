...
* [BKCI 硬件规格指南](setup/hardware.md)
* [BKCI 系统要求](setup/system-requirements.md)
...
* [流水线插件](store/plugins/README.md)
  * [开发一个流水线插件](store/plugins/create-plugin/README.md)
    ...
    * [流水线插件开发案例](store/plugins/create-plugin/case-stduy/README.md)
      * [sendmsg-通用消息发送插件](store/plugins/create-plugin/case-stduy/sendmsg.md)
...
* [FAQS](reference/faqs/README.md)
  ...
  * [流水线](reference/faqs/pipelines/README.md)
    ...
    * [使用常见问题](reference/faqs/pipelines/use/README.md)
      * [流水线编排](reference/faqs/pipelines/use/set\_up.md)
  ...
  * [代码库](reference/faqs/code\_repo.md)
  * [页面报错](reference/faqs/web\_error.md)
  * [服务异常](reference/faqs/services\_error.md)
  ...
  * [现有问题汇总](reference/faqs/xian-you-wen-ti-hui-zong.md)
